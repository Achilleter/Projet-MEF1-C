...
int main(){
    ...
    do{
        printf("Voulez vous jouer à 1 ou 2 personnes ? (tapez 1 ou 2) !\n");
        scanf("%d", &nbjoueurs);
    ...
    if(nbjoueurs == 1){
        ...
        int difficulte;
        do{
            printf("Choisissez le niveau de difficulté de l'IA ! (1:noob, 2:facile ou 3:moyen)\n");
            scanf("%d", &difficulte);
        ...
        if(difficulte == 1){
            printf("Vous avez choisi le niveau de difficulté noob !\n");
        }
        else if(difficulte == 2){
            printf("Vous avez choisi le niveau de difficulté facile !\n");
        }
        else{
            printf("Vous avez choisi le niveau de difficulté moyen (bon courage !) !\n");
        }
        do{
            printf("Rentrez votre nom d'équipe ! (20 caracteres au maximum)\n");
            scanf("%s", equipe1->nom);
        ...
        printf("Bonjour %s\n", equipe1->nom);
        equipe2->nom[0] = 'IA'; // Initialise le nom de l'IA
